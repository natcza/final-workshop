...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pizza_size', models.CharField(choices=[(1, 'small'), (2, 'medium'), (3, 'big')], default='2', max_length=1)),
                ('pizza', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.Pizza')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pizza_top', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.Topping')),
            ],
        ),
        migrations.AddField(
